...
namespace OnboardingBackend.Controllers
{
  ...
  public class PersonalDetailsController : ControllerBase
  {
    ...
    [HttpPut]
    public async Task<IActionResult> Put(PersonalDetailsModel newPersonalDetails)
    {
      ...
      if (auth is null)
      {
        SlackErrorMessage.SlackError(auth, office, id, "PersonalDetails");
        return Unauthorized();
      }
      ...
      var response = await _userService.UpdatePersonalDetailsAsync(id, newPersonalDetails);
